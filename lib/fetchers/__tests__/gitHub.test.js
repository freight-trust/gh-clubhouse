...
(0, _blueTape2.default)("fetchers/gitHub", function (t) {
  t.test("getIssue returns a Promise", function (tt) {
    ...
    (0, _nock2.default)("https://api.github.com")
  ...
  t.test("getCommentsForIssue returns a Promise", function (tt) {
    ...
    var expected = [
      {
        url:
          "https://api.github.com/repos/some-owner/some-repo/issues/1/comments/1",
        id: 123,
        body: "uh oh",
      },
      {
        url:
          "https://api.github.com/repos/some-owner/some-repo/issues/1/comments/2",
        id: 234,
        body: "me, too",
      },
    ];
  ...
  t.test("createIssue returns a Promise", function (tt) {
    ...
    (0, _nock2.default)("https://api.github.com")
      ...
      .reply(201, (0, _stringify2.default)(expected));
