...
(0, _blueTape2.default)("fetchers/clubhouse", function (t) {
  t.test("getStory returns a Promise", function (tt) {
    ...
    (0, _nock2.default)("https://api.clubhouse.io")
      .get("/api/v2/stories/123?token=not-a-real-token")
      .reply(200, (0, _stringify2.default)(expected));

    return (0, _clubhouse.getStory)("not-a-real-token", 123).then(function (
      data
    ) {
  ...
  t.test("listProjects returns a Promise", function (tt) {
    ...
    return (0, _clubhouse.listProjects)("not-a-real-token").then(function (
      data
    ) {
      return tt.deepEqual(data, expected);
    });
  ...
  t.test("createStory returns a Promise", function (tt) {
    ...
    return (0, _clubhouse.createStory)("not-a-real-token", story).then(
      function (data) {
        return tt.deepEqual(data, expected);
      }
    );
