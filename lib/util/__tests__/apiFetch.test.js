...
(0, _blueTape2.default)("util/apiFetch", function (t) {
  t.test("apiFetch", function (tt) {
    tt.test("throws an APIError if unsuccessful", function (ttt) {
      ...
      (0, _nock2.default)("https://api.example.com")
        .get("/some/path")
      ...
      return _promise2.default.all([
        ttt.shouldFail(
          (0, _apiFetch.apiFetch)("https://api.example.com/some/path")
        ),
        ttt.shouldFail(
          (0, _apiFetch.apiFetch)("https://api.example.com/some/other/path")
        ),
      ]);
    });
    ...
    tt.test("returns a Promise of data if successful", function (tt) {
      ...
      (0, _nock2.default)("https://api.example.com")
        ...
        .reply(200, (0, _stringify2.default)(expectedResults));

      return (0, _apiFetch.apiFetch)(
        "https://api.example.com/yet/another/path"
      ).then(function (data) {
  ...
  t.test("apiFetchAllPages", function (tt) {
    tt.test("returns a Promise of all pages of data if successful", function (
      ttt
    ) {
      ttt.plan(1);
      ...
      (0, _nock2.default)("https://api.example.com")
        .get("/yet/another/path")
        .reply(200, (0, _stringify2.default)(page1Data), {
          Link:
            '<https://api.example.com/yet/another/path?page=2>; rel="next", <https://api.example.com/yet/another/path?page=3>; rel="last"',
        })
        .get("/yet/another/path?page=2")
        .reply(200, (0, _stringify2.default)(page2Data), {
          Link:
            '<https://api.example.com/yet/another/path?page=3>; rel="next", <https://api.example.com/yet/another/path?page=3>; rel="last"',
        })
        .get("/yet/another/path?page=3")
        .reply(200, (0, _stringify2.default)(page3Data), {
          Link: '<https://api.example.com/yet/another/path?page=3>; rel="last"',
        });

      return (0, _apiFetch.apiFetchAllPages)(
        "https://api.example.com/yet/another/path"
      ).then(function (data) {
