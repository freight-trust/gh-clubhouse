...
(0, _tape2.default)("util/config", function (t) {
  t.test("saveConfig", function (tt) {
    tt.test("saves the configuration options", function (ttt) {
      ...
      var savedOptions = JSON.parse(
        _fs2.default.readFileSync(pathname, { encoding: "utf8" })
      );
  ...
  t.test("loadConfig", function (tt) {
    tt.test("returns an empty object if no configuration exists", function (
      ttt
    ) {
      ttt.plan(1);
    ...
    tt.test(
      "returns the options as an object if the configuration exists",
      function (ttt) {
        ttt.plan(1);
