...
test("fetchers/clubhouse", (t) => {
  t.test("getStory returns a Promise", (tt) => {
    ...
    return getStory("not-a-real-token", 123).then((data) =>
      tt.deepEqual(data, expected)
    );
  });
  ...
  t.test("listUsers returns a Promise", (tt) => {
    ...
    return listUsers("not-a-real-token").then((data) =>
      tt.deepEqual(data, expected)
    );
  });
  ...
  t.test("listProjects returns a Promise", (tt) => {
    ...
    return listProjects("not-a-real-token").then((data) =>
      tt.deepEqual(data, expected)
    );
  });
  ...
  t.test("createStory returns a Promise", (tt) => {
    ...
    return createStory("not-a-real-token", story).then((data) =>
      tt.deepEqual(data, expected)
    );
  });
